...
```{r pheno,eval=TRUE,fig.width=11,fig.height=11}
...
* IMC container can change to SummarizedExperiment and the FlowSOM algorithm can be used.
```{r classChange,fig.width=11,fig.height=11}
  library(CATALYST)
library(cowplot)
library(flowCore)
library(ggplot2)
